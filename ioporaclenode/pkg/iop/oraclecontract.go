...
func (_OracleContract *OracleContractTransactor) SubmitVerification(opts *bind.TransactOpts, _id *big.Int, _result bool, _signatures [][]byte) (*types.Transaction, error) {
	return _OracleContract.contract.Transact(opts, "submitVerification", _id, _result, _signatures)
}

// SubmitVerification is a paid mutator transaction binding the contract method 0xa68c964b.
//
// Solidity: function submitVerification(uint256 _id, bool _result, bytes[] _signatures) returns()
func (_OracleContract *OracleContractSession) SubmitVerification(_id *big.Int, _result bool, _signatures [][]byte) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitVerification(&_OracleContract.TransactOpts, _id, _result, _signatures)
}

// SubmitVerification is a paid mutator transaction binding the contract method 0xa68c964b.
//
// Solidity: function submitVerification(uint256 _id, bool _result, bytes[] _signatures) returns()
func (_OracleContract *OracleContractTransactorSession) SubmitVerification(_id *big.Int, _result bool, _signatures [][]byte) (*types.Transaction, error) {
	return _OracleContract.Contract.SubmitVerification(&_OracleContract.TransactOpts, _id, _result, _signatures)
}
