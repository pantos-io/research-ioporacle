 ...
 * @dev Added hashToPoint function from https://github.com/ChihChengLiang/bls_solidity_python
 * to https://github.com/witnet/bls-solidity
 */
library BN256G1 {
    ...
    function addPoint(uint256[4] memory input)
        internal
    ...
    function mulPoint(uint256[3] memory input)
        internal
        returns (uint256, uint256)
    {
        bool success;
    ...
    function hashToPointKeccak256(bytes memory data)
        internal
        view
    ...
    function hashToPointSha256(bytes memory data)
        internal
        view
        returns (uint256[2] memory p)
    {
